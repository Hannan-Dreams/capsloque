    ...
    return (
        ...
        >
            ...
            >
                {/* Main Pill */}
                <motion.div
                    className="navbar-pill relative"
                    animate={{
                        ...
                        boxShadow: scrolled
                            ? '0 8px 32px rgba(0, 0, 0, 0.4), 0 0 20px rgba(230, 0, 0, 0.06), inset 0 1px 0 rgba(255, 255, 255, 0.05)'
                    ...
                    <div className="flex items-center justify-between px-4 py-2.5 md:px-6 md:py-3">
                        ...
                        <motion.div variants={linkVariants} className="hidden md:block">
                            <Link
                                ...
                                onMouseEnter={(e) => {
                                    e.currentTarget.style.boxShadow = '0 0 24px rgba(230, 0, 0, 0.4)';
                        ...
                        >
                            <div className="py-3 px-4 space-y-1">
                                {navLinks.map((link, index) => (
                                    ...
                                    >
                                        <Link
                                            ...
                                            className="flex items-center gap-3 px-4 py-3 rounded-xl text-white/60 hover:text-white hover:bg-white/[0.04] font-medium text-sm transition-all duration-200"
                                        >
                                ...
                                <motion.div
                                    initial={{ opacity: 0, x: -12 }}
                                    animate={{ opacity: 1, x: 0 }}
                                    transition={{ delay: navLinks.length * 0.06, type: 'spring', stiffness: 200, damping: 20 }}
                                    className="pt-2"
                                >
                                    <Link
                                        href="#contact"
                                        onClick={() => setMobileMenuOpen(false)}
                                        className="block text-center py-3 rounded-xl text-sm font-semibold text-white transition-all duration-300"
                                        style={{
                                            background: 'linear-gradient(135deg, #e60000, #cc0000)',
                                        }}
                                    >
