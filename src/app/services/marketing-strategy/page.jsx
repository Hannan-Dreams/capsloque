        ...
        <main className="min-h-screen pt-24 pb-20 bg-[#0a0a0a]">
            ...
            <section className="relative py-20 overflow-hidden">
                ...
                <div className="container mx-auto px-6 relative z-10">
                    ...
                    >
                        <span className="text-[#e60000] font-medium uppercase tracking-wider text-sm">Growth Solutions</span>
            ...
            <section className="py-20">
                <div className="container mx-auto px-6">
                    ...
                    >
                        <h2 className="text-3xl font-bold text-white mb-4">Marketing Channels</h2>
                        <p className="text-white/40">We optimize across all major platforms</p>
                    </motion.div>
