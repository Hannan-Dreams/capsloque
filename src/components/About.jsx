        ...
        <section id="about" className="section relative overflow-hidden bg-[#0a0a0a]">
            ...
            <div className="container mx-auto px-4 sm:px-6 relative z-10">
                ...
                >
                    ...
                    <p className="section-subtitle mt-4 px-4">
                        A forward-thinking tech venture dedicated to building innovative
                ...
                <motion.div
                    ...
                    className="glass p-6 sm:p-8 md:p-12 max-w-4xl mx-auto"
                >
                    <div className="grid grid-cols-3 gap-4 sm:gap-8 md:gap-12 text-center">
                        {stats.map((stat, index) => (
                            ...
                            >
                                <div
                                    className="text-3xl sm:text-4xl md:text-5xl font-bold mb-2 transition-all duration-300"
